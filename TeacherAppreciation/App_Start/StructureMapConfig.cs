...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(TeacherAppreciation.StructureMapConfig), "Configure")]
namespace TeacherAppreciation
{
	public static class StructureMapConfig
	{
		public static void Configure()
		{
			IoC.Container.Configure(cfg =>
			{
				...
				cfg.AddRegistry(new ActionFilterRegistry(namespacePrefix: "TeacherAppreciation"));
